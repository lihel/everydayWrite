...
export default class Header extends React.Component {
    ...
    render() {
        ...
        return <div>
            {userInfo.map((val)=>
                <UserInfo key={val.user_id} myHome={myHome} setting={setting} logOut={logOut} onSignUp={onSignUp}
                          onSignIn={onSignIn} user_name={val.user_name} head_path={val.headPath}/>
            )}
        </div>
    }
}
